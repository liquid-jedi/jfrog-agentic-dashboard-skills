...
[![version](https://img.shields.io/badge/jfrog--ciso--report-v4.1.0-blue)](#whats-new)
...
`Example Reports/ciso-reports/` holds real v4.1.0 output, so you can see exactly
