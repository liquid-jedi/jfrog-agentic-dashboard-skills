...
[![version](https://img.shields.io/badge/jfrog--ciso--report-v3.0.0-blue)](#)
...
| Tab | Contents |
|-----|----------|
| **Overview** | Executive KPI strip, independent posture signals, SLA/fixability/coverage insight cards, top actions |
| **Curation** | Gate results, supported-ecosystem coverage gaps, enforcement opportunity, malicious package defense, policy catalog |
...
Need the older tagged release instead?
